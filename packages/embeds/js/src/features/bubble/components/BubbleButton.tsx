    ...
    <Show when={isNotDefined(props.customCloseIconSrc)}>
      ...
      >
        <path
          fill-rule="evenodd"
          clip-rule="evenodd"
          d="M66.8487 84.579C64.1709 87.2569 59.8292 87.2569 57.1513 84.579L25.7059 53.1336C21.3861 48.8139 24.4455 41.4277 30.5546 41.4277L93.4454 41.4277C99.5544 41.4277 102.614 48.8139 98.2941 53.1336L66.8487 84.579Z"
        />
        {/* <path
          fill-rule="evenodd"
          clip-rule="evenodd"
